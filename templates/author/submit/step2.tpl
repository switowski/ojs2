...
<tr>
	...
	<td width="70%" class="value">
		<input type="file" class="uploadField ignore-file" name="submissionFile" id="submissionFile" /> <input name="uploadSubmissionFile" type="submit" class="button" value="{translate key="common.upload"}" />
