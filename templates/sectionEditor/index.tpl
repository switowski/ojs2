...
<form method="post" id="submit" action="{url op="index" path=$pageToDisplay}">
	<div class="row">
		<div class="col-md-2 text-search-editor">{translate key="editor.submissions.inSection"}</div>
	...
	<div class="col-md-3 col-md-offset-5" >
		<input type="submit" value="{translate key="common.search"}" class="btn btn-success btn-lg btn-block" class="margin-top-10" />
	</div>
</form>
</div>
