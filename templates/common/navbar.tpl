...
<div id="navbar">
	<ul class="menu">
		<li {if $requestedPage eq 'index' or $requestedPage eq ''}class="active"{/if} id="read"><a href="{url page="index"}">Read</a>
			<ul>
				<li class="first {if $currentUrl|strstr:"/search"} active{/if}" id="search"><a href="{url page="search"}">{translate key="navigation.search"}</a></li>
