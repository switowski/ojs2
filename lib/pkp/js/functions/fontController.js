...
function fontSize(container, target, minSize, defSize, maxSize, baseUrl) {
	...
	var prefix = "<ul>";
	var suffix = "</ul>";
	var smallFontHtml = "<li><a href='javascript:void(0);' class='pkp_controllers_fontController_smallFont' title='" + minCaption +"'>" + minCaption + "</a></li>";
	var defFontHtml = "<li><a href='javascript:void(0);' class='pkp_controllers_fontController_defaultFont' title='" + defCaption +"'>" + defCaption + "</a></li>";
	var largeFontHtml = "<li><a href='javascript:void(0);' class='pkp_controllers_fontController_largeFont' title='" + maxCaption +"'>" + maxCaption + "</a></li>";
	$(container).html(prefix + smallFontHtml + defFontHtml + largeFontHtml + suffix);
